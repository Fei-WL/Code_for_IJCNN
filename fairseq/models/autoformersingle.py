...
class AutoformerModel(FairseqEncoderDecoderModel):
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return AutoformerSingleEncoder(args, src_dict, embed_tokens)
...
class AutoformerSingleEncoder(FairseqEncoder):
    """
    ...
    def build_encoder_layer(self, args):
        return AutoformerSingleEncoderLayer(args)
    ...
    def forward(
        ...
        for layer in self.layers:
            curr, prev = layer(curr_x=curr, prev_x=prev,
