...
@register_model("autoformertest")
class AutoformerTestModel(FairseqEncoderDecoderModel):
    @classmethod
    def hub_models(cls):
        # fmt: off
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return AutoformerTestEncoder(args, src_dict, embed_tokens)
...
class AutoformerTestEncoder(FairseqEncoder):
    """
...
@register_model_architecture("autoformertest", "autoformertest")
